...
void writeROOT()
{
  cerr << endl << " Writing all histograms into anaMUSE_Roy.root" << endl;
  
  TFile *f_out = new TFile("anaMUSE_Roy.root", "RECREATE");
  ...
  f_out -> Write();
  f_out->Close();
  cerr<<"End of writing histograms to anaMUSE_Roy.root"<<endl<<endl;
