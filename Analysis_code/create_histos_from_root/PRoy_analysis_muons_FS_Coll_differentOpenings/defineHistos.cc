...
void defineHistos()
{
  ...
  sprintf(name,"xDet0a");
  xDet0a = new TH1F(name,name,43,-0.43,0.43);
  xDet0a->GetXaxis()->SetTitle("x_startQTA1 (cm)");

  sprintf(name,"xDetAQTA1");
  xDetAQTA1 = new TH1F(name,name,43,-0.43,0.43);
  ...
  sprintf(name,"xDet3");
  xDet3 = new TH1F(name,name,25,-12.5,12.5);
  ...
  xDetTar = new TH1F(name,name,54, -6.5, 6.5);
  xDetTar->GetXaxis()->SetTitle("x_PiM1Tar (cm)");

  //in y
  sprintf(name,"yDet0");
  yDet0 = new TH1F(name,name,22,-0.11,0.11);
  yDet0->GetXaxis()->SetTitle("y_ProdTar (cm)");
  
  sprintf(name,"yDet0a");
  yDet0a = new TH1F(name,name,20.5,-10,11);
  yDet0a->GetXaxis()->SetTitle("y_startQTA1 (cm)");

  sprintf(name,"yDetAQTA1");
  yDetAQTA1 = new TH1F(name,name,100,-10,10);
  ...
  yDetAQTB2 = new TH1F(name,name,40,-5,5);
  ...
  sprintf(name,"yDet3");
  yDet3 = new TH1F(name,name, 48,-2.4,2.4);
  ...
  yDetTar = new TH1F(name,name,100,-1, 1);
  ...
  sprintf(name,"pxDet3");
  pxDet3 = new TH1F(name,name,21,-4.5,6);
  ...
  sprintf(name,"pyDet3");
  pyDet3 = new TH1F(name,name,46,-23,23);
  ...
  pyDetTar = new TH1F(name,name,46,-115,115);
  ...
  dpDet0a = new TH1F(name,name,35,-1.75,1.75);
  ...
  sprintf(name,"dpDet3");
  dpDet3 = new TH1F(name,name,34,-1.7,1.7);
  ...
  beamspot_DetAQTA1 = new TH2F(name, name,20,-0.2,0.2, 20,-10,10);
  ...
  beamspot_Det3 = new TH2F(name, name,24,-12,12, 24,-2.4,2.4);
  ...
  beamspot_DetTar = new TH2F(name, name,15,-1.5,1.5,20,-0.4,0.4);
  ...
  pxpy_Det0a = new TH2F(name, name,40,-0.4,0.4, 40,-4,4);
 ...
 pxpy_Det2 = new TH2F(name, name,500,-1,1, 500,-1,1);
  ...
  xPx_Det3 = new TH2F(name, name,24,-12,12,25,-4.5,5.5);
  ...
  xPx_DetTar = new TH2F(name, name,40,-2,2,25,-6,6.5);
  ...
  yPy_Det3 = new TH2F(name, name,24,-2.4,2.4,22,-22,22);
  ...
  yPy_DetTar = new TH2F(name, name,30,-0.4,0.4,36,-90,90);
...
// dp vs x
  ...
  dispersion_IFP = new TH2F(name, name,24,-12,12,34,-1.7,1.7);
  ...
  dispersion_Tar = new TH2F(name, name,20,-2,2,34,-1.7,1.7);
  ...
  dpPx_Det0a = new TH2F(name, name,30,-4,4,13,-1.7,1.7);
  ...
  dpPx_Det3 = new TH2F(name, name,25,-4.5,5.5,34,-1.7,1.7);
  ...
  dpPx_DetTar = new TH2F(name, name,25,-6,6.5,34,-1.7,1.7);
  ...
  ydp_Det0a = new TH2F(name, name,30,-10,10, 13,-1.7,1.7);
  ...
  ydp_Det3 = new TH2F(name, name,24,-2.4,2.4,34,-1.7,1.7);
  ...
  ydp_DetTar = new TH2F(name, name,20,-0.4,0.4,34,-1.7,1.7);
  ...
  dpPy_Det0a = new TH2F(name, name,30,-100,100,13,-1.7,1.7);
  ...
  dpPy_Det3 = new TH2F(name, name,22,-22,22,34,-1.7,1.7);
  ...
  dpPy_DetTar = new TH2F(name, name,36,-90,90,17,-1.7,1.7);
